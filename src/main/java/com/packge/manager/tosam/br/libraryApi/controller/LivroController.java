...
public class LivroController implements GenericController {
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE', 'ADMIN')")
    @Operation(summary = "Pesquisa paginada", description = "Realiza pesquisa de livros.")
    public ResponseEntity<Page<ResultadoPesquisaLivroDTO>> pesquisa(
            ...
            @RequestParam(value = "numero-elementos", defaultValue = "10") Integer numero_elementos
    ) {
    ...
    @PutMapping("{id}")
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE', 'ADMIN')")
    @Operation(summary = "Atualizar", description = "Atualizar Livro")
